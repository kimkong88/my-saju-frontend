    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-24">
                {/* --- LEFT CONTENT: Clarity & Insight --- */}
                <div className="lg:w-1/2 order-1">
                    <h2 className="font-serif text-4xl md:text-6xl text-slate-900 mb-8 leading-tight">
                        How It Works.
                    </h2>

                    <p className="font-serif text-sm md:text-base text-slate-700 mb-12 leading-relaxed max-w-md">
                        We transform your birth moment into a precise
                        personality blueprint using astronomical calculations.
                        Your exact date, time, and location create a unique
                        signature from{" "}
                        <strong className="text-slate-900 font-semibold">
                            10.3 million
                        </strong>{" "}
                        possible combinations—calculated, not categorized.
                    </p>
                    ...
                    <div className="flex flex-col border-t border-slate-200">
                        {[
                            ...
                            <div
                                key={idx}
                                className="group flex items-center py-5 border-b border-slate-200 hover:border-slate-900 transition-colors cursor-default"
                            >
                                <div className="flex items-center gap-6">
                                    <span className="font-serif italic text-slate-300 w-8 text-lg group-hover:text-slate-900 transition-colors">
                                        0{idx + 1}
                                    </span>
                                    <span className="font-serif text-xs uppercase tracking-widest font-bold text-slate-900">
                                        {label}
                                    </span>
                                </div>
                            </div>
                ...
                {/* --- RIGHT CONTENT: Kept your original Graphic --- */}
