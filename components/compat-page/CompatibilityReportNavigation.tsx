...
// Dynamic chapters - will be populated based on categories
const baseChapters = [
    { id: "birth-chart", title: "Your Charts", shortTitle: "Charts" },
    { id: "compatibility-overview", title: "Compatibility Overview", shortTitle: "Overview" },
];

// Category IDs that will be added dynamically - Communication first
const categoryIds = [
    "communication",
    "romance",
    "work",
...
const categoryTitles: Record<string, { title: string; shortTitle: string }> = {
    romance: { title: "Romance", shortTitle: "Romance" },
    work: { title: "Work", shortTitle: "Work" },
    lifestyle: { title: "Lifestyle", shortTitle: "Lifestyle" },
    communication: { title: "Communication", shortTitle: "Comm" },
};

function getChapters() {
    const categoryChapters = categoryIds.map((id) => ({
        id: `category-${id}`,
        title: categoryTitles[id].title,
        shortTitle: categoryTitles[id].shortTitle,
    }));
...
export default function CompatibilityReportNavigation() {
