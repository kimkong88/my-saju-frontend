...
interface CompatibilityShareSectionProps {
    person1: {
        identity: {
            code: string;
            title: string;
...
export default function CompatibilityShareSection({
    ...
    const handleShare = async (platform: string) => {
        ...
        if (platform === "twitter") {
            ...
            navigator.share({
                title: pairingTitle?.name || "Compatibility Report",
                text: shareText,
                url: reportUrl,
            });
        }
    ...
    const handleEmailShare = () => {
        const subject = encodeURIComponent(
            pairingTitle
                ? `Compatibility Report - ${pairingTitle.name}`
                : `Compatibility Report - ${person1.identity.title} × ${person2.identity.title}`
        );
    ...
    // Use person1's element for the card background (or person2's if person1 doesn't have one)
    const cardElement = person1.identity.element || person2.identity.element;
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="max-w-4xl mb-12 md:mb-16">
                    ...
                    <p className="text-lg md:text-xl text-slate-700 leading-relaxed max-w-2xl">
                        Share your compatibility results with others.
                    </p>
                </div>
                ...
                <div className="max-w-4xl mb-12 md:mb-16">
                    <div
                        ...
                        style={getElementBgStyle(cardElement)}
                    >
                        ...
                        {rarity && (
                            <div className="text-sm text-white/70 border-t border-white/20 pt-4 mt-4">
                                1 in {rarity.oneIn.toLocaleString()} pairings
                            </div>
                        )}
                    </div>
                </div>
                        ...
                        <div className="bg-white border border-slate-200 p-6 md:p-8">
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-slate-600 leading-relaxed">
                                    Share your complete compatibility report
                                    with others. This link shows your full
                                    analysis.
                                </p>
                            </div>
