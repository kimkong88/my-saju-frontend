...
interface MeLifeQuestionsProps {
            ...
            <div className="text-center space-y-4">
                ...
                <div>
                    ...
                    <p className="text-xs md:text-sm text-slate-600 leading-relaxed">
                        Generating insights tailored to your unique birth chart
                    </p>
                </div>
...
export default function MeLifeQuestions({
    initialResponse,
    scope = "me",
}: MeLifeQuestionsProps) {
    ...
    return (
        <section className="pt-12 md:pt-16 pb-12 md:pb-16 px-6 xl:px-0 bg-slate-50 border-t border-slate-200">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-2">
                        <div className="flex-1">
                            ...
                            <p className="text-sm md:text-base text-slate-600">
                                Get personalized insights tailored to your
                                unique birth chart
                            </p>
                        </div>
                    </div>
